...
const std::string DecoSkybox::DECO_SKYBOX_TEXTURES[6]			= {
	GameAssets::RESOURCE_DIR + "/" + GameAssets::TEXTURE_DIR + "/deco_spirals1024x1024.jpg", GameAssets::RESOURCE_DIR + "/" + GameAssets::TEXTURE_DIR + "/deco_spirals1024x1024.jpg",
	GameAssets::RESOURCE_DIR + "/" + GameAssets::TEXTURE_DIR + "/deco_spirals1024x1024.jpg", GameAssets::RESOURCE_DIR + "/" + GameAssets::TEXTURE_DIR + "/deco_spirals1024x1024.jpg",
	GameAssets::RESOURCE_DIR + "/" + GameAssets::TEXTURE_DIR + "/deco_spirals1024x1024.jpg", GameAssets::RESOURCE_DIR + "/" + GameAssets::TEXTURE_DIR + "/deco_spirals1024x1024.jpg"
};
...
DecoSkybox* DecoSkybox::CreateDecoSkybox(const std::string& meshFilepath) {
	...
	TextureCube* skyboxTex = TextureCube::CreateCubeTextureFromImgFiles(DECO_SKYBOX_TEXTURES, Texture::Bilinear);
	if (skyboxTex == NULL) {
		return NULL;
	}
