...
GOTHIC_ROMANTIC_BOSS_TOP_POINT_MESH(GOTHIC_ROMANTIC_MESH_DIRECTORY "/gothic_romantic_boss_top_point.obj"),
GOTHIC_ROMANTIC_BOSS_BOTTOM_POINT_MESH(GOTHIC_ROMANTIC_MESH_DIRECTORY "/gothic_romantic_boss_bottom_point.obj"),
GOTHIC_ROMANTIC_BOSS_BODY_MESH(GOTHIC_ROMANTIC_MESH_DIRECTORY "/gothic_romantic_boss_body.obj"),
GOTHIC_ROMANTIC_BOSS_LEG_MESH(GOTHIC_ROMANTIC_MESH_DIRECTORY "/gothic_romantic_boss_leg.obj"),
