...
TEXTURE_CIRCLE(TEXTURE_DIRECTORY "/circle_32x32.png"),
...
DEFAULT_FG_KEY_LIGHT_ATTEN(0.0f),
DEFAULT_FG_FILL_LIGHT_ATTEN(0.037f),
...
DEFAULT_FG_KEY_LIGHT_POSITION(Point3D(-20.0f, 40.0f, 70.0f)),
