...
Name "Biff! Bam!! Blammo!?! Demo"

RequestExecutionLevel user

Function create_desktop_shortcut_action
SetOutPath $INSTDIR
CreateShortcut "$DESKTOP\Biff Bam Blammo Demo.lnk" "$INSTDIR\BiffBamBlammoDemo.exe"
FunctionEnd
...
!define MUI_STARTMENUPAGE_DEFAULTFOLDER "Biff Bam Blammo Demo"

!define MUI_FINISHPAGE_NOAUTOCLOSE
!define MUI_FINISHPAGE_RUN "$INSTDIR\BiffBamBlammoDemo.exe"
...
OutFile bbb_demo_installer.exe
InstallDir "$PROGRAMFILES\Biff Bam Blammo Demo"
CRCCheck on
XPStyle on
ShowInstDetails show
VIProductVersion 1.0.0.0
VIAddVersionKey /LANG=${LANG_ENGLISH} ProductName "Biff! Bam!! Blammo!?! Demo"
...
#    restart_installing_cpp_redist:
    ...
    IfErrors success_installing_cpp_redist
...
Section "Biff! Bam!! Blammo!?! Demo" SEC0000
    SetOutPath $INSTDIR
    SetOverwrite on
    File ..\lib\cg.dll
    File ..\lib\cgGL.dll
...
Section -post SEC0002
    ...
    SetOutPath $INSTDIR
    WriteUninstaller $INSTDIR\bbb_demo_uninstaller.exe
    !insertmacro MUI_STARTMENU_WRITE_BEGIN Application
	SetOutPath $INSTDIR
	CreateDirectory $SMPROGRAMS\$StartMenuGroup
    CreateShortcut "$SMPROGRAMS\$StartMenuGroup\$(^ExeLink).lnk" "$INSTDIR\BiffBamBlammoDemo.exe"
    CreateShortcut "$SMPROGRAMS\$StartMenuGroup\$(^UninstallLink).lnk" "$INSTDIR\bbb_demo_uninstaller.exe"
    !insertmacro MUI_STARTMENU_WRITE_END
    WriteRegStr HKLM "SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\$(^Name)" DisplayName "$(^Name)"
    WriteRegStr HKLM "SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\$(^Name)" DisplayVersion "${VERSION}"
    WriteRegStr HKLM "SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\$(^Name)" Publisher "${COMPANY}"
    WriteRegStr HKLM "SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\$(^Name)" DisplayIcon $INSTDIR\bbb_demo_uninstaller.exe
    WriteRegStr HKLM "SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\$(^Name)" UninstallString $INSTDIR\bbb_demo_uninstaller.exe
...
Section /o "-un.Biff! Bam!! Blammo!?! Demo Install" UNSEC0000
    Delete /REBOOTOK $INSTDIR\BiffBamBlammo.ico
    Delete /REBOOTOK $INSTDIR\BiffBamBlammoDemo.exe
    ...
    DeleteRegValue HKLM "${REGKEY}\Components" "Biff! Bam!! Blammo!?! Demo Install"
SectionEnd
...
Section -un.post UNSEC0002
    ...
    Delete /REBOOTOK "$DESKTOP\Biff Bam Blammo Demo.lnk"
    Delete /REBOOTOK $INSTDIR\bbb_demo_uninstaller.exe
...
Function .onInit
    InitPluginsDir
    Push $R1
    File /oname=$PLUGINSDIR\spltmp.bmp BBB_Demo_Logo.bmp
...
Function un.onInit
    ...
    !insertmacro SELECT_UNSECTION "Biff! Bam!! Blammo!?! Demo Install" ${UNSEC0000}
FunctionEnd

# Installer Language Strings
# TODO Update the Language Strings with the appropriate translations.

LangString ^UninstallLink ${LANG_ENGLISH} "Uninstall Biff Bam Blammo Demo"
LangString ^ExeLink ${LANG_ENGLISH} "Biff Bam Blammo Demo"